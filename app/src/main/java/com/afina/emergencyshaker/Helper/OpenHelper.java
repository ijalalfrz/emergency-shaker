...
public class OpenHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_TARGET_CREATE = "CREATE TABLE TARGET (ID INTEGER PRIMARY KEY AUTOINCREMENT, NAMA TEXT, JUMLAH_SHAKE INTEGER, TELEPON TEXT, NOTIF TEXT, SMS TEXT, EMAIL TEXT)";
